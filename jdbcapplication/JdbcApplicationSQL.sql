...
insert into model_type (name) values  ('BMW M5'), ('Chevrolet Camaro'), ('Toyota Alphard'), ('Mazda RX-8'),
('Suzuki Ninja'), ('Volgswagen Transporter'), ('Honda CBR'), ('Audi A4'), ('Ford Focus'), ('Mercedes Transporter');
...
values  ('BMW M5'), ('Chevrolet Camaro'), ('Toyota Alphard'), ('Mazda RX-8'),
('Suzuki Ninja'), ('Volgswagen Transporter'), ('Honda CBR'), ('Audi A4'), ('Ford Focus'), ('Mercedes Transporter');
...
insert into client (first_name, last_name) values ('Optimus','Prime'), ('Ethan','Hunt'), ('Rocky','Balboa'),
('Forrest','Gump'), ('Travis','Bickle'), ('john','McCane'), ('Jefrey','Lebowski'), ('Tyler','Durden'),
('John','Connor'), ('Bruce','Wayne');
...
insert into transport (model_type_id, transport_type_id, client_id) values (1, 1, 10), (2, 1, 9), (3, 3, 8), (4, 1, 7),
(5, 2, 6), (6, 3, 5), (7, 2, 4), (8, 1, 3), (9, 1, 2), (10, 2, 1);
